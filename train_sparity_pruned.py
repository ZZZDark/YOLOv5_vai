...
from models.yolo import ModelPrunedMax
import numpy as np
import torch
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    opt.hyp = hyp.copy()  # for saving hyps to
    ...
    if pretrained:
        ...
        model = ModelPrunedMax(maskbndict, ckpt['model'].yaml, ch=3, nc=nc, anchors=hyp.get('anchors')).to(
            device)  # create
    ...
    tb_writer = SummaryWriter(save_dir / 'bn_weight')
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=r'E:\YOLO\yolov5_62\weights\5n0.01s0.5p0.01s0.3s.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default=r'E:\YOLO\yolov5_62\data\plane.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=r'E:\YOLO\yolov5_62\data\hyps\hyp.scratch-low.yaml', help='hyperparameters path')
