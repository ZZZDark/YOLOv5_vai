...
def parse_opt():
    ...
    parser.add_argument('--prune', type=float, default=0.2, help='prune percentage')

    parser.add_argument('--weights', type=str, default=r'E:\YOLO\yolov5_62\weights\5n0.01s0.5p0.01s0.3s0.01s.pt', help='initial weights path')
