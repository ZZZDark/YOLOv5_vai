...
class DetectPrunedMaxMultiBackend(nn.Module):
    # YOLOv5 MultiBackend class for python inference on various backends
    def __init__(self, weights='yolov5s.pt', device=None, dnn=False):
        ...
        #   TensorRT:               *.engine
        from models.experimental import attempt_download, attempt_load_pruned_max  # scoped to avoid circular import
        ...
        if jit:  # TorchScript
            ...
            model = attempt_load_pruned_max(weights if isinstance(weights, list) else w, map_location=device)
