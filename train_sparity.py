            ...
            if f.exists():
                ...
                if f is best:
                    ...
                    results, _, _ = val.run(
                        ...
                        iou_thres=0.65 if is_coco else 0.10,  # best pycocotools results at 0.65
                        single_cls=single_cls,
                        dataloader=val_loader,
                        save_dir=save_dir,
                        save_json=is_coco,
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=r'E:\YOLO\yolov5_62\weights\yolov5n.pt', help='initial weights path')
